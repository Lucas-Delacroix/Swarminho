...
plt.legend()
plt.grid(True)
plt.savefig("src/graphics/plots/grafico1.png")
...
plt.grid(True)
plt.savefig("src/graphics/plots/grafico2.png")
...
plt.grid(True)
plt.savefig("src/graphics/plots/grafico3.png")
...
plt.grid(True)
plt.savefig("src/graphics/plots/grafico4.png")
...
plt.grid(True)
plt.savefig("src/graphics/plots/grafico5.png")
...
plt.grid(True)
plt.savefig("src/graphics/plots/grafico6.png")
